...
//				Monster monster = RandomReturn<Monster> (chapterDetailInfo.GetMonsters());
...
//					exploreMainViewController.OnEnterBattle (chapterDetailInfo.GetMonsters(),mChapterEventView);
//				});
//				break;
//			case EventType.NPC:
//				NPC npc = RandomReturn<NPC> (chapterDetailInfo.GetNPCs());
